...
public class Ship extends Vehicle
{
    ...
    final double fuelRate = 2.1;
    final int speedRate = 70;
    final int slowRate = 57;

    public Ship(String name, int speed, int fuel, int cargoCapacity){
        super(name, speed, fuel);
        this.cargoCapacity = cargoCapacity;
    }
    public Ship(String name, int speed, int fuel, int cargoCapacity, int overload){
        super(name, speed, fuel);
        this.cargoCapacity = cargoCapacity;
